...
%% Tailored for PPK Bioproses, ppkb
%%
\documentclass[12pt]{article}
%% Enable either one of these %%
%\usepackage{finalxm}			% standard for everyone
%\usepackage[ppkb,ftquestionnum]{finalxm}		% Figure 1.1
%\usepackage[ppkb,ftquestionnumx]{finalxm}		% Figure A1.1
%\usepackage[ppkb,ftquestionnum, minutes]{finalxm}	% show hours & minutes
\usepackage[ppkb,ftquestionnumx, minutes]{finalxm}	% show hours & minutes
%\usepackage[ppkb,ftquestionnum,answers]{finalxm}	% answer scheme
%\usepackage[ppkb,ftquestionnumx,answers]{finalxm}	% answer scheme
...
\captionsetup[table]{labelsep=colon, textfont=normalfont} 	% no bold table
